...
public class IT23373648Lab3Q3 {
public static void main(String [] args){
Scanner input = new Scanner(System.in);

int amount;

System.out.print("Enter anmount :");
...
System.out.println("200 Notes - " +(amount/20));
amount = amount % 20;

System.out.println("10 Notes - " +(amount/10));
amount = amount % 10;

System.out.println("05 Notes - " +(amount/5));
amount = amount % 5;

System.out.println("02 Notes - " +(amount/2));
amount = amount % 2; 

System.out. println("01 Notes - " + amount);
 }
}